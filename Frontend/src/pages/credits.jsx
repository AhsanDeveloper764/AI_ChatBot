      ...
      <div className='flex flex-wrap justify-center gap-8'>
        {
          plans.map((item,index) => { 
            return (
              ...
              ${item._id === "pro" ? "bg-purple-50 dark:bg-purple-900" : "bg-white dark:bg-transparent"}`}>
                <div className='flex-1 '>
                  <h3 className='text-xl font-semibold text-gray-900 dark:text-white mb-2'>{item.name}</h3>
                  <p className='text-2xl font-bold text-purple-600 dark:text-purple-300 mb-4'>${item.price} 
